/** @module shared/composables/useTheme - 主题切换组合式函数，支持明暗模式切换与 View Transition 涟漪动画 */
import { ref, computed, watch } from 'vue'
import { invalidateCssVarCache } from '@/shared/utils/format'
...
/** 主题切换组合式函数，提供当前模式读取、模式设置与带涟漪动画的切换能力
 * @returns mode - 当前主题模式的响应式引用
 * @returns isDark - 是否为暗色模式的计算属性
 * @returns setMode - 直接设置主题模式的函数
 * @returns toggleTheme - 切换明暗主题，支持 View Transition 涟漪动画
 */
